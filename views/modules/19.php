...
<main id="main" class="main fs-Poppins color-primario">
    ...
    <div class="card row mb-2 p-2">
        <h5 class="card-title">AP PROTECCION DENTAL [19] <span>| Vigencia 01/01/2018 AL 19/08/2018</span></h5>
            ...
            <table id="myTable" class="table table-hover table-bordered table-light">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>URGENCIAS</td>
                        <td>RAYOS X</td>
                        <td class="text-bg-warning">Periapicales individuales y coronales requeridas RETROALVEOLAR: RAYOS POR PIEZA DENTARIA</td>
                        <td>100%</td>
                        <td>ilimitados</td>
                    ...
                    <tr>
                        ...
                        <td>100%</td>
                        <td>3 eventos por año de vigencia</td>
                    ...
                    <tr>
                        ...
                        <td class="text-bg-warning">Obturacion amalgama simple, compuesta o compleja diente temporal (odontopediatria) INSTRUCCIÓN ORAL MAS TECNICAS DE CEPILLADO (MOLARES) SELLANTE NIÑO DE 2 A 6 AÑOS</td>
                        <td>Es una aleacion de metales que se utiliza para restaurar los tejidos perdidos por caries</td>
                        <td>100%</td>
                        <td>Por caries o fractura dental o desalojo de tapadura: 2 eventos por año de vigencia</td>

...
<main id="main" class="main vh-100">
    <div class="pagetitle d-flex align-items-center">
        ...
        <div class="info-header pt-3">
            <h1>AP CLÍNICA DOMICILIARIA [Código 21]</h1>
            <nav>
                <ol class="breadcrumb">
    ...
    <div class="card p-3 ">
        <h5 class="card-title">Listado de Pólizas <span>Vigencia | 01/01/2018 AL 19/08/2018</span> </h5>

        <span class="badge rounded-pill text-bg-warning p-1 mb-3">Seguro por muerte accidental por 200 UF</span>

        <span class="badge rounded-pill text-bg-danger p-1 mb-3">NOTA : PARA EL SEGURO DE MUERTE SE CONCTATA DIRECTAMENTE CON LA ASEGURADORA</span>

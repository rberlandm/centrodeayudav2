...
<main id="main" class="main fs-Poppins">
    ...
    <div class="card p-3 ">
        ...
        <div class="table-responsive mb-3">
            <table id="detallePoliza" class="table color-primario">
                ...
                <tbody>
                    <tr class="">
                        ...
                        <td>Telemedicina Medicina General</td>
                        <td>Entrega atención médica vía Telemedicina, realizada por un médico de Medicina General acreditado. La atención aborda las consultas del paciente y tratamiento médico según historial clínico, revis
                        ...
                        <td rowspan="7">La Asistencia Telemedicina Turbus es para el Titular del pasaje y su grupo familiar contemplando un máximo de 4 integrantes (titular +3 beneficiarios). Si Cliente no tiene beneficiarios directos, él puede ceder a terceros los servicios, que serán asignados por él, considerando el número y los topes
                            máximos de eventos contratados para el grupo de beneficiarios asignados, en donde la edad máxima
                            de ingreso y permanencia no tiene tope.</td>
                    </tr>

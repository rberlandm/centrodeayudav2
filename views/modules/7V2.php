...
<main id="main" class="main fs-Poppins color-primario">
    ...
    <div class="card row mb-2 p-2">
        <h5 class="card-title">AP CLÍNICA DOMICILIARIA [7v2] <span>| Vigencia 30/09/2016 AL 26/03/2017</span></h5>
        ...
        <p><span class="d-flex align-items-center"><i class='bx bxs-message-alt-error text-danger  me-2'></i> NOTA : EN EL MEDICO A DOMICILIO EL TIEMPO DE RESPUESTA DE LA SOLICITUD EN LOS SECTORES FUERA DE RADIO URBANO DE LA CIUDAD SERA DETERMINADO POR LA DISTANCIA. QUE SE ENCUENTRA EL CLIENTE .</span></p>
                    ...
                    <tr>
                        ...
                        <td>
                            <ul class="list-style-none m-0 p-0">
                                ...
                                <li class="d-flex align-items-center"><i class='bx bxs-message-alt-error text-warning'></i> TRIGLICERIDOS VDRL</li>
                            </ul>
                        </td>
                        <td>Copago $0</td>
                        <td>1 Evento</td>

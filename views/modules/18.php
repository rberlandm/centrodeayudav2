...
<main id="main" class="main fs-Poppins color-primario">
    ...
    <div class="card row mb-2 p-2">
        <h5 class="card-title">AP MEDICO INTEGRAL [18] <span>| Vigencia 01/01/2018 AL 19/08/2018</span></h5>
            ...
            <table class="table table-hover table-bordered table-light">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-bg-warning">Orientacion Medica Telefonica</td>
                        <td class="text-bg-warning">Orientacion Medica Telefonica</td>
                        <td class="text-center">Sin limites</td>
                        <td class="text-center">Sin limites</td>
                        <td>No se envian recetas ni licencias medica bajo ninguna via</td>
                    </tr>
